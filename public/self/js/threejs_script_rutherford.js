...
var container = document.getElementById('threejs-container-rutherford');
...
const sphere_au = new THREE.Mesh( new THREE.SphereGeometry( 15, 32, 16 ), new THREE.MeshStandardMaterial( { color: 0xaaaa00 } ) );
scene.add( sphere_au );
